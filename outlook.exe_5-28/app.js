...
host.onkeypress = function (e) {
    ...
    // "2"
        ...
        if (outlook == null) { // Can't find the window
            ...
            // Note: Something is wrong in here. 
            var emailButton = outlook.findFirst(function (el) { return 
                (el.name == "New Email"); }, 0, 5); // Inclusive
            ...
            if (myInvokePattern != null) { // QUESTIONS: Don't know if I need to check if null or not in here. Maybe catching exceptions?
                ...
                //host.setTimeout(function () {executeRest(desktop);}, 3000);

            }

            console.log("hyahahahahha");
        }
